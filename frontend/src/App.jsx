                    ...
                    {permit.slice(0, showAll ? permit.length : 1).map((p, index) => (
                        <div key={index} className="permit-card">
                            <div className='permit-main'>
                                <div className='permit-title'>{p.type}</div>
                                <div className='permit-details'>
                                    <div className='detail'><strong>Fee:</strong> {p.fee}</div>
                                    <div className='detail'><strong>Permit Type:</strong> {p.permit_type}</div>
                                    <div className='detail'><strong>Processing Time:</strong> {p.processing_time}</div>
                                    <div className='detail'><strong>Required:</strong> {p.required ? "Yes" : "No"}</div>
                                </div>
                            </div>
                        </div>
                    ))
